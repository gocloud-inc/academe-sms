...
<template>
	<div class="offcanvas" tabindex="-1" id="editEducation" aria-labelledby="editEducationLabel" data-te-offcanvas-init>
		<div class="offcanvas-header">
			<h5 class="offcanvas-title" id="editEducationLabel">
				Edit education
			</h5>
