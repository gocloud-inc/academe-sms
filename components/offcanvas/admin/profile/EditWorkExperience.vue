...
<template>
	<div class="offcanvas" tabindex="-1" id="editWorkExperience" aria-labelledby="editWorkExperienceLabel" data-te-offcanvas-init>
		<div class="offcanvas-header">
			<h5 class="offcanvas-title" id="editWorkExperienceLabel">
