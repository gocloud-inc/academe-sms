...
<template>
	<div class="w-full md:max-w-5xl md:mx-10">		
		<div class="card lg:p-8 md:p-4">
			<div class="card-body md:flex md:items-center md:gap-24">
				<img class="hidden pointer-events-none md:block w-1/2" src="~/assets/img/vector/login.svg" alt="Login Vector">

				<div class="md:max-w-sm md:ml-auto">
					...
					<div class="mt-8">
						<form @submit.prevent="login" class="space-y-6">
							...
							<div class="form-group">
								...
								<div class="relative">
									<input v-model="user.password" id="password" class="form-control form-control-lg password" type="password" name="password" required autocomplete="current-password" />
